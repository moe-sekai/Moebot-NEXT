...
export function getAssetCdnBase(
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getAssetBaseUrl(
	...
	return (
		ASSET_BASE_URL_MAP[source as AssetSourceType] ??
		ASSET_BASE_URL_MAP["main-jp"]
	);
}

function buildImageAssetUrl(
...
function buildPngImageAssetUrl(
	source: AssetSourceType | string,
	assetPath: string,
): string {
...
export function getCommonMaterialThumbnailUrl(
	...
	return buildImageAssetUrl(
		source,
		`thumbnail/common_material/${assetbundleName}`,
	);
}

export function getAttrIconUrl(
	attr: string,
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getUnitLogoUrl(
	unitId: string,
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getCardThumbnailUrl(
	...
	const { assetbundleName, trained, source } = resolveCardAssetArgs(
		first,
		second,
		third,
		fourth,
	...
	const format =
		(typeof first === "number"
			? fifth
			: typeof fourth === "string" && (fourth === "webp" || fourth === "png")
				? fourth
				: fifth) ?? "png";
	const status = trained ? "after_training" : "normal";
	return withImageExtension(
		buildImageAssetUrl(source, `thumbnail/chara/${assetbundleName}_${status}`),
		format,
	);
}
...
export function getCardFullUrl(
	...
	return withImageExtension(
		buildImageAssetUrl(
			source,
			`character/member/${assetbundleName}/card_${status}`,
		),
		format,
	);
}
...
export function getMusicScoreUrl(
	musicId: number,
	difficulty: string,
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getMusicJacketUrl(
	assetbundleName: string,
	source: AssetSourceType | string = "main-jp",
): string {
	return buildImageAssetUrl(
		source,
		`music/jacket/${assetbundleName}/${assetbundleName}`,
	);
}

export function getMusicVocalAudioUrl(
	assetbundleName: string,
	source: AssetSourceType | string = "main-jp",
): string {
	return buildAudioAssetUrl(
		source,
		`music/long/${assetbundleName}/${assetbundleName}`,
	);
}
...
export function getEventCharacterUrl(
	assetbundleName: string,
	source: AssetSourceType | string = "main-jp",
): string {
	return buildImageAssetUrl(
		source,
		`event/${assetbundleName}/screen/character`,
	);
}

export function getEventLogoUrl(
	assetbundleName: string,
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getEventStoryBannerUrl(
	assetbundleName: string,
	source: AssetSourceType | string = "main-jp",
): string {
	return buildImageAssetUrl(
		source,
		`event_story/${assetbundleName}/screen_image/banner_event_story`,
	);
}

export function getEventBgmUrl(
	assetbundleName: string,
	source: AssetSourceType | string = "main-jp",
): string {
	return buildAudioAssetUrl(
		source,
		`event/${assetbundleName}/bgm/${assetbundleName}_top`,
	);
}

export function getGachaLogoUrl(
	assetbundleName: string,
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getGachaBannerUrl(
	gachaId: number,
	source?: AssetSourceType | string,
): string;
export function getGachaBannerUrl(
...
export function getGachaBannerUrl(
	gachaIdOrBundle: number | string,
	source: AssetSourceType | string = "main-jp",
): string {
	const assetbundleName =
		typeof gachaIdOrBundle === "number"
			? `banner_gacha${gachaIdOrBundle}`
			: gachaIdOrBundle;
	return buildImageAssetUrl(
		source,
		`home/banner/${assetbundleName}/${assetbundleName}`,
	);
}

export function getGachaScreenUrl(
	assetbundleName: string,
	gachaId: number,
	source: AssetSourceType | string = "main-jp",
): string {
	return buildImageAssetUrl(
		source,
		`gacha/${assetbundleName}/screen/texture/bg_gacha${gachaId}`,
	);
}

export function getCardGachaVoiceUrl(
	assetbundleName: string,
	source: AssetSourceType | string = "main-jp",
): string {
	return buildAudioAssetUrl(
		source,
		`sound/gacha/get_voice/${assetbundleName}/${assetbundleName}`,
	);
}

export function getComicUrl(
	assetbundleName: string,
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getStampUrl(
	...
	return buildPngImageAssetUrl(
		source,
		`stamp/${assetbundleName}/${assetbundleName}`,
	);
}

export function getVirtualLiveBannerUrl(
	assetbundleName: string,
	source: AssetSourceType | string = "main-jp",
): string {
	return buildImageAssetUrl(
		source,
		`virtual_live/select/banner/${assetbundleName}/${assetbundleName}`,
	);
}

export function getCharacterTrimUrl(
	characterId: number,
	source: AssetSourceType | string = "main-jp",
): string {
	return buildImageAssetUrl(
		source,
		`character/character_select/chr_tl_${characterId}`,
	);
}

export function getCharacterLabelHUrl(
	characterId: number,
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getCharacterLabelVUrl(
	characterId: number,
	source: AssetSourceType | string = "main-jp",
): string {
	return buildImageAssetUrl(
		source,
		`character/label_vertical/chr_v_lb_${characterId}`,
	);
}

export function getCharacterSelectUrl(
	characterId: number,
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getHonorBgUrl(
	...
	return buildImageAssetUrl(
		source,
		`honor/${assetbundleName}/degree_${sub ? "sub" : "main"}`,
	);
}

export function getHonorFrameUrl(
	rarity: string,
	sub = false,
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getHonorCustomFrameUrl(
	frameName: string,
	rarity: string,
	sub = false,
	source: AssetSourceType | string = "main-jp",
	...
	return buildImageAssetUrl(
		source,
		`honor_frame/${frameName}/frame_degree_${size}_${num}`,
	);
}

export function getHonorRankUrl(
	assetbundleName: string,
	type: "rank" | "scroll" = "rank",
	sub = false,
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getHonorRankMatchBgUrl(
	assetbundleName: string,
	sub = false,
	source: AssetSourceType | string = "main-jp",
): string {
	return buildImageAssetUrl(
		source,
		`rank_live/honor/${assetbundleName}/degree_${sub ? "sub" : "main"}`,
	);
}

export function getBondsHonorWordUrl(
	assetbundleName: string,
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getBondsHonorCharacterUrl(
	characterId: number,
	source: AssetSourceType | string = "main-jp",
): string {
	...
	return buildImageAssetUrl(
		source,
		`bonds_honor/character/chr_sd_${paddedId}_01`,
	);
}

export function getHonorLevelIconUrl(
	source: AssetSourceType | string = "main-jp",
): string {
	return buildImageAssetUrl(source, "honor/frame/icon_degreeLv");
}

export function getHonorUrl(
	assetbundleName: string,
	_level: string = "rank1",
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getScenarioJsonUrl(
	scenarioPath: string,
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getStoryVoiceUrl(
	scenarioId: string,
	voiceId: string,
	source: AssetSourceType | string = "main-jp",
): string {
	return buildAudioAssetUrl(
		source,
		`sound/scenario/voice/${scenarioId}/${voiceId}`,
	);
}

export function getCardStoryVoiceUrl(
	scenarioId: string,
	voiceId: string,
	source: AssetSourceType | string = "main-jp",
): string {
	return buildAudioAssetUrl(
		source,
		`sound/card_scenario/voice/${scenarioId}/${voiceId}`,
	);
}

export function getAreaTalkVoiceUrl(
	scenarioId: string,
	voiceId: string,
	source: AssetSourceType | string = "main-jp",
): string {
	return buildAudioAssetUrl(
		source,
		`sound/actionset/voice/${scenarioId}/${voiceId}`,
	);
}

export function getSpecialStoryVoiceUrl(
	scenarioId: string,
	voiceId: string,
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getStoryBgmUrl(
	bgmName: string,
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getStorySoundEffectUrl(
	seName: string,
	source: AssetSourceType | string = "main-jp",
): string {
...
export function getStoryEpisodeImageUrl(
	assetbundleName: string,
	episodeNo: number,
	source: AssetSourceType | string = "main-jp",
): string {
	...
	return buildImageAssetUrl(
		source,
		`event_story/${assetbundleName}/episode_image/${assetbundleName}_${paddedNo}`,
	);
}
...
export function getUnitStoryEpisodeImageUrl(
	...
	return buildImageAssetUrl(
		source,
		`story/episode_image/${chapterAssetbundleName}/${episodeAssetbundleName}`,
	);
}
