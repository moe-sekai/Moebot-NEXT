...
var baseDefinitions = []Definition{
	{
		ID:               "card-detail",
		Name:             "查卡详情图",
		Description:      "搜索卡牌信息，支持卡牌 ID、卡名、角色名和模糊关键词。",
		PrimaryCommand:   "查卡",
		Commands:         []string{"查卡"},
		Usage:            "/查卡 [ID/关键词]",
		...
		Examples:         []string{"/查卡 1204", "/card 初音未来", "/cardinfo 1204"},
		RequiresArgument: true,
		ArgumentHint:     "请输入卡牌 ID、卡名、角色名或关键词",
	...
	},
	{
		ID:               "event-info",
		Name:             "活动信息图",
		Description:      "搜索活动信息，支持活动 ID、活动名、类型和团组关键词。",
		PrimaryCommand:   "查活动",
		Commands:         []string{"查活动"},
		Usage:            "/查活动 [ID/关键词]",
		Template:         "event_info",
		...
		Examples:         []string{"/查活动 136", "/event 周年"},
		RequiresArgument: true,
		ArgumentHint:     "请输入活动 ID、活动名或关键词",
	...
	},
	{
		ID:               "gacha-info",
		Name:             "卡池信息图",
		Description:      "搜索卡池/扭蛋信息，支持 ID、卡池名、类型和 pickup 相关关键词。",
		PrimaryCommand:   "查卡池",
		...
		Examples:         []string{"/查卡池 700", "/查扭蛋 限定", "/gacha festival"},
		RequiresArgument: true,
		ArgumentHint:     "请输入卡池 ID、卡池名或关键词",
	...
	},
	{
		ID:             "ranking-list",
		Name:           "实时排行图",
		Description:    "查询活动榜线或指定名次。WebUI 解析页使用静态预览兜底，聊天端仍走实时榜线接口。",
		PrimaryCommand: "榜线",
		Commands:       []string{"榜线", "排行"},
		Usage:          "/榜线 [名次]",
		Template:       "ranking_list",
		PreviewID:      "ranking-list",
		PresetAliases:  []string{"rank", "ranking"},
		Examples:       []string{"/榜线", "/排行 1000", "/rank 100"},
		ArgumentHint:   "可选：输入要查询的名次",
