...
var baseDefinitions = []Definition{
	...
	},
	{
		...
		PresetAliases:    []string{"music", "song"},
		Examples:         []string{"/查曲 Tell Your World", "/查歌 千本樱", "/song 1"},
		RequiresArgument: true,
	...
	},
	{
		ID:               "chart-detail",
		Name:             "查谱详情图",
		Description:      "查询曲目谱面等级、Notes 数与谱面摘要。",
		PrimaryCommand:   "查谱",
		Commands:         []string{"查谱"},
		Usage:            "/查谱 [ID/关键词]",
		Template:         "chart_detail",
		PreviewID:        "chart-detail",
		PresetAliases:    []string{"chart", "chartinfo"},
		Examples:         []string{"/查谱 Tell Your World", "/chart 1"},
		RequiresArgument: true,
	...
	},
	{
		ID:             "profile-card",
		Name:           "个人信息图",
		Description:    "查看已绑定账号的玩家资料。WebUI 解析页使用预览样例，聊天端会按用户绑定账号查询。",
		PrimaryCommand: "个人信息",
	...
	},
	{
		ID:             "suite-status",
		Name:           "Suite 抓包状态",
		Description:    "查询已绑定账号的 Suite 抓包数据更新时间、来源和获取模式。",
		PrimaryCommand: "抓包状态",
	...
	},
	{
		ID:             "suite-mode",
		Name:           "Suite 抓包模式",
		Description:    "设置 Suite 抓包数据来源：latest/local/haruki/moesekai。",
		PrimaryCommand: "抓包模式",
		Commands:       []string{"抓包模式"},
		Usage:          "/抓包模式 [latest/local/haruki/moesekai]",
		Template:       "help_card",
		PreviewID:      "help-card",
		Examples:       []string{"/抓包模式", "/抓包模式 moesekai"},
		SearchType:     SearchTypeNone,
		RenderMode:     RenderModePreview,
	},
	{
	...
	},
	{
		ID:             "gacha-history",
		Name:           "抽卡记录",
		Description:    "查询绑定账号的 Suite 抽卡记录汇总。",
		PrimaryCommand: "抽卡记录",
		Commands:       []string{"抽卡记录", "抽卡统计"},
		Usage:          "/抽卡记录",
		Template:       "help_card",
		PreviewID:      "help-card",
		PresetAliases:  []string{"gachalog"},
		Examples:       []string{"/抽卡记录", "/cn抽卡记录"},
		SearchType:     SearchTypeNone,
		RenderMode:     RenderModePreview,
	},
	{
		ID:             "bond-list",
		Name:           "羁绊查询",
		Description:    "查询绑定账号的 Suite 羁绊等级 TOP 列表。",
		PrimaryCommand: "羁绊",
	...
	},
	{
		ID:             "music-progress",
		Name:           "打歌进度",
		Description:    "查询绑定账号的 Suite 打歌进度统计。",
		PrimaryCommand: "打歌进度",
		Commands:       []string{"打歌进度", "歌曲进度", "打歌信息"},
		Usage:          "/打歌进度",
		Template:       "help_card",
		PreviewID:      "help-card",
		PresetAliases:  []string{"progress"},
		Examples:       []string{"/打歌进度", "/cn打歌进度"},
		SearchType:     SearchTypeNone,
		RenderMode:     RenderModePreview,
	},
	{
		ID:             "material-info",
		Name:           "材料信息",
		Description:    "查询绑定账号的 Suite 材料持有数量。",
		PrimaryCommand: "材料信息",
		Commands:       []string{"材料信息", "材料", "素材"},
		Usage:          "/材料信息",
		Template:       "help_card",
		PreviewID:      "help-card",
		PresetAliases:  []string{"material", "materials"},
		Examples:       []string{"/材料信息", "/cn材料"},
		SearchType:     SearchTypeNone,
		RenderMode:     RenderModePreview,
	},
	{
		ID:             "challenge-info",
		Name:           "挑战信息",
		Description:    "查询绑定账号的 Suite 挑战 Live 进度统计。",
		PrimaryCommand: "挑战信息",
		Commands:       []string{"挑战信息", "挑战进度", "挑战详情", "每日挑战"},
		Usage:          "/挑战信息",
		Template:       "help_card",
		PreviewID:      "help-card",
	...
	},
	{
		ID:             "event-record",
		Name:           "活动记录",
		Description:    "查询绑定账号的 Suite 活动 PT 和 WL 章节记录。",
		PrimaryCommand: "活动记录",
		Commands:       []string{"活动记录", "活动履历"},
		Usage:          "/活动记录",
		Template:       "help_card",
		PreviewID:      "help-card",
		PresetAliases:  []string{"eventrecord"},
		Examples:       []string{"/活动记录", "/cn活动记录"},
		SearchType:     SearchTypeNone,
		RenderMode:     RenderModePreview,
	},
	{
		ID:             "leader-count",
		Name:           "队长次数",
		Description:    "查询绑定账号的 Suite 角色队长游玩次数排行。",
		PrimaryCommand: "队长次数",
	...
	},
	{
		ID:             "music-reward",
		Name:           "歌曲奖励",
		Description:    "查询绑定账号的 Suite 歌曲奖励达成数量统计。",
		PrimaryCommand: "歌曲奖励",
		Commands:       []string{"歌曲奖励", "打歌奖励", "歌曲挖矿", "打歌挖矿"},
		Usage:          "/歌曲奖励",
		Template:       "help_card",
		PreviewID:      "help-card",
		PresetAliases:  []string{"musicreward"},
		Examples:       []string{"/歌曲奖励", "/cn歌曲奖励"},
		SearchType:     SearchTypeNone,
		RenderMode:     RenderModePreview,
	},
	{
