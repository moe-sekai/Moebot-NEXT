...
var baseDefinitions = []Definition{
	...
	},
	{
		ID:              "gacha-history",
		Name:            "抽卡记录",
		Description:     "查询绑定账号的 Suite 抽卡记录汇总。WebUI 可输入临时区服与游戏 UID 调试。",
		PrimaryCommand:  "抽卡记录",
	...
	},
	{
		ID:              "music-progress",
		Name:            "打歌进度",
		Description:     "查询绑定账号的 Suite 打歌进度统计。WebUI 可输入临时区服与游戏 UID 调试。",
		PrimaryCommand:  "打歌进度",
	...
	},
	{
		ID:              "material-info",
		Name:            "材料信息",
		Description:     "查询绑定账号的 Suite 材料持有数量。WebUI 可输入临时区服与游戏 UID 调试。",
		PrimaryCommand:  "材料信息",
	...
	},
	{
		ID:              "music-reward",
		Name:            "歌曲奖励",
		Description:     "查询绑定账号的 Suite 歌曲奖励达成数量统计。WebUI 可输入临时区服与游戏 UID 调试。",
		PrimaryCommand:  "歌曲奖励",
