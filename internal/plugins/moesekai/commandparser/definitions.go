...
var baseDefinitions = []Definition{
	...
	},
	{
		...
		ID:               "default-region",
		Name:             "默认区服",
		Description:      "查询或设置当前账号的默认 PJSK 区服。设置后无前缀指令会自动使用该区服。",
		PrimaryCommand:   "pjsk服务器",
		Commands:         []string{"pjsk服务器", "pjsk区服", "pjsk默认服务器", "pjsk默认区服"},
		Usage:            "/pjsk服务器 [jp/cn/tw/kr/en]",
		PresetAliases:    []string{"pjskregion", "pjskdefault"},
		Examples:         []string{"/pjsk服务器", "/pjsk服务器 jp", "/pjsk服务器 cn"},
		RequiresArgument: false,
		ArgumentHint:     "可选：jp/cn/tw/kr/en；留空查询当前默认",
		SearchType:       SearchTypeNone,
		RenderMode:       RenderModeAction,
	},
	{
		...
		ID:               "skill-calc",
		Name:             "倍率计算",
		Description:      "计算卡组技能倍率与实效。输入 5 个技能值（车头自身 + 队友 4 张），返回倍率与技能实际值。",
		PrimaryCommand:   "倍率计算",
		Commands:         []string{"倍率计算", "倍率"},
		Usage:            "/倍率计算 <车头> <队友1> <队友2> <队友3> <队友4>",
		Template:         "skill_calc",
		PresetAliases:    []string{"skill", "skillcalc"},
		Examples:         []string{"/倍率计算 100 80 80 80 80", "/倍率 110 90 90 80 80"},
		RequiresArgument: true,
		ArgumentHint:     "请输入 5 个技能值",
		SearchType:       SearchTypeNone,
		RenderMode:       RenderModePreview,
	},
	{
