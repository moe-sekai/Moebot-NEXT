...
func TestSearchAndBuildEventPayloadIncludesBonusCards(t *testing.T) {
	...
	payload, ok := selected.Payload.(renderpayloads.EventInfoPayload)
	if !ok {
...
func TestSearchAndBuildEventListPayload(t *testing.T) {
	...
	payload, ok := selected.Payload.(renderpayloads.EventListPayload)
	if !ok {
...
func TestSearchAndBuildMusicAliasListPayload(t *testing.T) {
	...
	payload, ok := selected.Payload.(renderpayloads.MusicListPayload)
	if !ok {
...
func TestSearchAndBuildChartPayloadUsesChartSource(t *testing.T) {
	...
	payload, ok := selected.Payload.(renderpayloads.MusicDetailPayload)
	if !ok {
