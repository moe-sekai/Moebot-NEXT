...
export interface GroupClientSummary {
  client_id: string;
  count: number;
}

export interface GroupsResponse extends PaginatedResponse<GroupRow> {
  clients: GroupClientSummary[];
}
...
export interface CommandStatsClientPoint {
  client_id: string;
  count: number;
}
...
export interface CommandStatsResponse {
  ...
  by_client: CommandStatsClientPoint[];
